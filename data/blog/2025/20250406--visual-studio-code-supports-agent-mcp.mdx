---
title: 'Visual Studio Code 正式支援 Agent/MCP'
subtitle: '一步完成所有建議設定'
date: '2025-04-06'
lastmod: '2025-04-06'
tags: ['github-copilot', 'vscode', 'openai', 'agent', 'mcp']
draft: false
summary: 'Agent mode/MCP/網路搜尋/NES (Next Edit Suggestion) 已在正式版釋出!!!'
images: ['/static/images/2025/ChatGPT%20Image%20Apr%206%2C%202025%2C%2004_50_27%20AM.png']
---

![](/static/images/2025/ChatGPT%20Image%20Apr%206%2C%202025%2C%2004_50_27%20AM.png)

[Visua Studio Code March 2025 (version 1.99)](https://code.visualstudio.com/updates/v1_99)

Agent mode/MCP/網路搜尋/NES (Next Edit Suggestion) 已在正式版釋出!!!

現在需要手動開啟，未來會預設開啟。

可參考 [Will 保哥整理的最佳 GitHub Copilot 設定](https://github.com/doggy8088/github-copilot-configs)，裡面提供很多相關建議設定的詳細說明。

若不想一個一個設定，可直接在 Ctrl + , 開啟 Settings，再點右上角「Open Settings (JSON)」圖示，再貼入以下一次設定完成:
